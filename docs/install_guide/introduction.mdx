...
<CardGroup cols={2}>
  <Card title="AWS CloudFormation" icon="aws" href="/install_guide/cloud_deploy/aws_cloudformation">
  ...
  <Card title="Helm Chart (Kubernetes)" icon="anchor" href="/install_guide/cloud_deploy/Helm_Chart">
...
<Columns cols={3}>
  <Card title="OpenClaw" icon="terminal" href="/install_guide/integrate/openclaw">
  ...
  <Card title="LangChain" icon="link" href="/install_guide/integrate/LangChain">
